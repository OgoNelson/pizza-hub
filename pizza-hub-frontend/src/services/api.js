...
export const adminAPI = {
  ...
  getOrders: (token) => api.get('/admin/orders', {
    headers: { Authorization: `Bearer ${token}` }
  }),
  getOrderById: (id, token) => api.get(`/admin/orders/${id}`, {
    headers: { Authorization: `Bearer ${token}` }
  }),
  updateDeliveryStatus: (id, token) => api.patch(`/admin/orders/${id}/deliver`, {}, {
    headers: { Authorization: `Bearer ${token}` }
  }),
  deleteOrder: (id, token) => api.delete(`/admin/orders/${id}`, {
    headers: { Authorization: `Bearer ${token}` }
  }),
